...
$identAppReplyUrl = "https://$($environmentName)authncs.b2clogin.com/$($environmentName)authncs.onmicrosoft.com"

$proxyAppName = "ProxyIdentityExperienceFramework"
$proxyAppReplyUrl = "https://$($environmentName)authncs.b2clogin.com/oauth2/nativeclient"
